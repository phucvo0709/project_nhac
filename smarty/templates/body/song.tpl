<script src="public/js/script_song.js"></script>
<script>
$(document).ready(function() {
    var id = {$doc_bai_hat->id};
    ...
    <div class="wrapper-page">
        <div class="wrap-body container">
                            ...
                            <div class="bar-nhac-trai col-12 col-sm-6 col-md-12 col-lg-12">
                                <div class="content">
                                    ...
                                    <div class="item-right">
                                        ...
                                        <span class="dangBoi">
                                            Đăng bởi: <a href="thanh_vien.php?id={$doc_bai_hat->dangBoi}">{$thanhVien->ten}</a>
                                        </span>
                                    </div>
                                    <div class="trackInfoBar">
                                        <span class="trackNameBar">
                                            ...
                                            {if isset($smarty.session.ten)}
                                                <a class="fa fa-download taiXuong" href="#" download></a>
                                            {else}
                                            ...
                                            {if isset($smarty.session.phanQuyen)}
                                                {if $smarty.session.dangBoi == $dangBoi}
                                                    <a href="sua.php?id={$doc_bai_hat->id}&caSi={$doc_bai_hat->caSi}&album={$doc_bai_hat->album}&theLoai={$doc_bai_hat->theLoai}" class="fa fa-pencil-square-o"></a>
                                                {/if}
                                                {if $smarty.session.phanQuyen =='1'}
                                                    <a href="xoa_bai_hat.php?id={$doc_bai_hat->id}" class="fa fa-trash"></a>
                                                {/if}
                                            {/if}
                                        </span>
            ...
            <div class="item_lien_quan">
                ...
                {foreach $lien_quan_the_loai as $lqtl}
                    <li class="w3-bar">
                        <a href="bai-hat/{thu_vien::Bo_dau($lqtl->tenBaiHat)}/{$lqtl->id}.htm"><i class="fa fa-play w3-bar-item w3-circle w3-hide-small" aria-hidden="true" style="width:85px"></i></a>
                    <div class="w3-bar-item">
                        <a class="item_bai_hat" href="song.php?id={$lqtl->id}">{$lqtl->tenBaiHat}</a><br>
                        <a class="item_ca_si" href="casi.php?id={$lqtl->caSi}">{$lqtl->tenCaSi}</a>
                    </div>
                    </li>
                {/foreach}
                </ul>
            ...
            <div class="item_lien_quan">
                ...
                <ul class="w3-ul w3-card-4">
                {foreach $lien_quan_ca_si as $lqcs}
                    <li class="w3-bar">
                        <a href="song.php?id={$lqcs->id}"><i class="fa fa-play w3-bar-item w3-circle w3-hide-small" aria-hidden="true" style="width:85px"></i></a>
                    <div class="w3-bar-item">
                         <a class="item_bai_hat" href="bai-hat/{thu_vien::Bo_dau($lqcs->tenBaiHat)}/{$lqcs->id}.htm">{$lqcs->tenBaiHat}</a><br>
                    </div>
                    </li>
                {/foreach}
                </ul>
